...
class IntentSlotDatasetReader(DatasetReader):
    ...
    def __init__(self,
                 ...
                 intent_token_indexers: Dict[str, TokenIndexer] = None,
        ...
        self._intent_token_indexers = intent_token_indexers or self._source_token_indexers
    ...
    def text_to_instance(self, source_string: str, target_string: str = None) -> Instance:  # type: ignore
        ...
        if target_string is not None:
            ...
            intent = tokenized_target[0]
            intent_fieled = TextField([intent], self._intent_token_indexers)
            fields_dict["intent_tokens"] = intent_fieled
            meta_fields["intent_tokens"] = [intent.text]
